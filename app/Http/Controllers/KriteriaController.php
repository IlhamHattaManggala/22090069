...
class KriteriaController extends Controller
{
    public function index()
    {
        ...
        return view('admin.kriteria', compact('kriteria', 'user', 'website'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Schema::table('nilai', function ($table) use ($nama) {
            $table->decimal($nama, 10, 1)->nullable();
        });
    ...
    public function update(Request $request, $column)
    {
        ...
        DB::statement("ALTER TABLE `nilai` CHANGE `$column` `$namaKolom` DECIMAL(10,1)");
