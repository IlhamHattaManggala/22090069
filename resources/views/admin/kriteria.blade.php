...
@php
    // Ambil session flash 'success' jika ada
    $successMessage = session('success');
@endphp

@if ($successMessage)
    <div class="toast" id="toast" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3000" style="position: fixed; top: 10px; right: 10px; z-index: 1000;">
