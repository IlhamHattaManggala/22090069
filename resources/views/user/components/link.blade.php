...
<link href="{{ asset('AdminLTE/plugins/remixicon/remixicon.css') }}" rel="stylesheet">
<link href="{{ asset('AdminLTE/plugins/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
<link rel="stylesheet" href="{{ url('AdminLTE/plugins/sweetalert2/sweetalert2.min.css') }}">

<!-- Main CSS File -->
<link href="{{ asset('AdminLTE/dist/css/user.css') }}" rel="stylesheet">